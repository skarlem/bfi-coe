  ...
  module.exports = function makeGetSingleCoeRequest({ getOneRequestUseCase }) {
    return async function getOneRequest(httpRequest) {
      try {
        ...
        const result = await getOneRequestUseCase({info});
        // result = {
